...
-- 1. Write a query to display the batch of the senior most alumni working as 'Project Manager'. Give an alias as Senior_PM_Batch.
select min(batch)as Senior_PM_Batch from profile
where designation="Project Manager";

-- 2. Write a query to display the batch of the junior most alumni working as 'Project Manager'. Give an alias as Junior_PM_Batch.
